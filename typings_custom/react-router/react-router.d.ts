...
declare module ReactRouter {
    ...
    function create(options: RouterCreateOption): RouterClass;
    function run(routes: Route, callback: RouterRunCallback): RouterClass;
    function run(routes: Route, location: LocationBase | string, callback: RouterRunCallback): RouterClass;
